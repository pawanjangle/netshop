...
const { createProduct, getProducts, updateProduct, deleteProduct, getProduct, getProductsByCategory } = require("../controllers/product");
...
router.post("/getproductsbycategory", requireLogin, getProductsByCategory );
